...
const galleryItems: GalleryItem[] = [
  {
    ...
    date: "২০১৩",
    description:
      "মাহমুদুর হাসান বিদ্যানিকেতনের ২০১৩ ব্যাচের প্রাক্তন শিক্ষার্থীদের স্মৃতিময় চিত্র।",
  },
  ...
  },
  {
    ...
    date: "২০২৬",
    description:
      "মাহমুদুর হাসান বিদ্যানিকেতনের নিবেদিতপ্রাণ শিক্ষক ও শিক্ষিকাবৃন্দ।",
  },
  {
    id: 4,
    title: "সাংস্কৃতিক অনুষ্ঠান ও মতবিনিময়",
    category: "সাংস্কৃতিক",
    src: "/images/gallery/t-2.jpg",
    date: "২০২৬",
    description: "বিদ্যালয়ের সাংস্কৃতিক পরিবেশনা ও গুণীজন সংবর্ধনা অনুষ্ঠান।",
  },
  {
    id: 5,
    title: "শিক্ষক সম্মেলন ও বিশেষ সভা",
    category: "শিক্ষকমণ্ডলী",
    src: "/images/gallery/t-3.jpg",
    date: "২০২৬",
    description:
      "শিক্ষার মানোন্নয়ন ও ভবিষ্যৎ পরিকল্পনা বিষয়ে শিক্ষকমণ্ডলীর বিশেষ সভা।",
  },
  {
    id: 6,
...
export default function Gallery() {
  ...
  return (
    <>
      <PageHero
        title="ফটো গ্যালারি"
        subtitle="মাহমুদুর হাসান বিদ্যানিকেতনের বিভিন্ন ইভেন্ট, ক্রীড়া, সাংস্কৃতিক কর্মকাণ্ড ও স্মরণীয় মুহূর্ত।"
      />
